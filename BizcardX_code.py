...
selected = option_menu("Menu", ["\U0001F3E0 Home", "\U0001F4E5 Upload & Extract", "\U0001F5D1 Modify or Delete"],
                       ...
                       styles={"nav-link": {"font-size": "25px", "text-align": "center", "margin": "0px",
                               ...
                               "nav-link-0": {"icon": "fa-home", "background-color": "#4285F4", "color": "white",
                                              "padding-left": "15px"}})
    ...
    with tab1:
        ...
        if uploaded_card is not None:
            def save_card(uploaded_card):
                with open(os.path.join(r"C:\Users\Dhanesh\Downloads\Project_3", uploaded_card.name), "wb") as f:
            ...
            with col1:
                ...
                with col2:
                    ...
                    with st.spinner("Please wait processing image..."):
                        ...
                        saved_img = r"C:\Users\Dhanesh\Downloads\Project_3\\" + uploaded_card.name
...
if selected == "\U0001F5D1 Modify or Delete":
    ...
    try:
        with column1:
            decription = ['company_name', 'card_holder', 'designation', 'mobile_number', 'email', 'website', 'area',
                          'city', 'state', 'pin_code']
            ...
            mycursor.execute(
                f"select company_name,card_holder,designation,mobile_number,email,website,area,city,state,pin_code from card_details WHERE '{selected_card}'=%s",
                (selected_card,))
            ...
            if st.button("view updated data"):
                mycursor.execute(
                    "select company_name,card_holder,designation,mobile_number,email,website,area,city,state,pin_code from card_details")
        ...
        with column2:
            ...
            decription1 = ['company_name', 'card_holder', 'designation', 'mobile_number', 'email', 'website', 'area',
                           'city', 'state', 'pin_code']
            dropdown = st.selectbox("Select the description", decription)
            mycursor.execute(f"SELECT {dropdown} FROM card_details")
            result = mycursor.fetchall()
